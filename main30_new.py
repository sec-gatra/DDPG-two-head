...
parser.add_argument('--Max_train_steps', type=int, default=230000, help='Max training steps')
...
parser.add_argument('--random_steps', type=int, default=50000, help='random steps before training')
    ...
    while total_steps < opt.Max_train_steps:
        ...
        while not done and total_steps < opt.Max_train_steps:
            ...
            if total_steps % opt.eval_interval == 0:
                ...
                print(f"Step {total_steps}, Avg EE: {avg_metrics['avg_EE']:.2f}, Rate OK: {avg_metrics['data_rate_pass']}")
