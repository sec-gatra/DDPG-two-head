...
parser.add_argument('--a_lr', type=float, default=1e-3, help='Learning rate of actor') # 1e-4
parser.add_argument('--c_lr', type=float, default=1e-4, help='Learning rate of critic') # 1e-5 bagus
        ...
        while total_steps < opt.Max_train_steps: # ini loop episode. Jadi total episode adalah Max_train_steps/200
            ...
            while not done: 
                ...
                if total_steps % opt.eval_interval == 0:
                    ...
                    if result['avg_EE'] >= 30 and result['data_rate_lolos']>=0.7*env.nodes :
