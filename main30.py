...
from utils30 import str2bool,evaluate_policy, evaluate_policy_reward
...
parser.add_argument('--Max_train_steps', type=int, default = 100, help='Max training steps') #aslinya 5e6
...
parser.add_argument('--random_steps', type=int, default=20, help='random steps before trianing')
parser.add_argument('--noise', type=float, default=0.000001, help='exploring noise') #aslinya 0.1
