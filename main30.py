...
parser.add_argument('--Max_train_steps', type=int, default = 240000, help='Max training steps') #aslinya 5e6
...
parser.add_argument('--a_lr', type=float, default=4e-4, help='Learning rate of actor') # 2e-3
