...
parser.add_argument('--Max_train_steps', type=int, default = 6000, help='Max training steps') #aslinya 5e6
...
parser.add_argument('--random_steps', type=int, default=700, help='random steps before trianing')#70000
...
def main():
    ...
    if opt.render:
        ...
        R_min = 0.12  # Ganti sesuai kebutuhan
